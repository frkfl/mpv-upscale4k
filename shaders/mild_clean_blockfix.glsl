//!PARAM mcb_clean_strength
//!TYPE float
1.0

//!HOOK MAIN
//!BIND HOOKED
//!DESC [Custom] Mild Clean &BlockFix

// Edge-aware denoise + flat deblock + dering + stochastic gating
...
vec4 hook() {
    ...
    float s = clamp(mcb_clean_strength, 0.0, 1.0);
