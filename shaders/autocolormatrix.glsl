...
const mat3 OKLAB_M1 = mat3(
    0.4122214708, 0.2119034982, 0.0883024619,  // column 0: R -> L, M, S
    0.5363325363, 0.6806995451, 0.2817188376,  // column 1: G -> L, M, S
    0.0514459929, 0.1073969566, 0.6299787005   // column 2: B -> L, M, S
);
const mat3 OKLAB_M2 = mat3(
     0.2104542553,  1.9779984951,  0.0259040371,  // column 0: l -> L, a, b
     0.7936177850, -2.4285922050,  0.7827717662,  // column 1: m -> L, a, b
    -0.0040720468,  0.4505937099, -0.8086757660   // column 2: s -> L, a, b
);
